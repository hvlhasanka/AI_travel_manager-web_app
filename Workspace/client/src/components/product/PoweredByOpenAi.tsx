...
export default function PoweredByOpenAi() {
  return (
    <div className="fixed z-10 bottom-4 right-4 sm:bottom-6 sm:right-6 lg:bottom-10 lg:right-10 flex items-center gap-1.5 sm:gap-2 pointer-events-none drop-shadow-xl">
